        ...
        <div className='h-screen flex justify-center items-center bg-blue-50'>
            <div className='h-[80vh] mx-10 container bg-white shadow-lg'>
                ...
                <div className='flex py-12 mx-12 justify-center'>
                    <div className='text-center h-[20rem] w-[20rem] shadow-lg mt-10'>
                        ...
                        <div className='mx-10'>
                            ...
                            <button className='bg-blue-600 text-white px-8 py-2 my-2 rounded-md'>Suscribe</button>
                        </div>
                    </div>
                    ...
                    <div className='text-center h-[20rem] w-[20rem] shadow-lg mt-10'>
                        ...
                        <div className='mx-10'>
                            ...
                            <button className='border border-black text-black px-8 py-2 my-2 rounded-md hover:bg-stone-200'>Suscribe</button>
                        </div>
                    </div>
                </div>
            </div>
